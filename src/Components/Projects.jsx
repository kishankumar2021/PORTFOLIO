    ...
    const projectData = [
     ...
     const projectData1 = [
    
        {
           ...
           des2:"DESCRIPTION", a1:"Users can register and then login", a2:"Users can scroll through the products, view the product details", a3:"Add Money to the wallet"},
