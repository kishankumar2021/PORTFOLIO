        ...
        <SecCont id = 'top'>
            <ContBg>
                <Cont>
                    <Left>
                        <Para>Hi I'm</Para>
                        <Header>Kishan Kumar</Header>
                        <Para className="full">Full-Stack Web Developer, living in Bihar(India)</Para>
                        <ContactBtn> <a href="https://www.linkedin.com/in/kishan-002/" target="_blank" rel="noreferrer noopener" >Contact me</a></ContactBtn>
                    </Left>
                    <Right>
                        {/* <img src="dpkbg.png" alt="" /> */}
                        <img src="kk.jpeg" alt="" className={styles.pic} />
                    </Right>
                </Cont>
                <AboutCont>
